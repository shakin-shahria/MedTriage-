...
def preprocess(df: pd.DataFrame):
    ...
    # Identify numeric vs categorical features roughly by dtype and domain
...
def main():
    ...
    best_model, metrics, search = train_and_evaluate(X_train, X_test, y_train, y_test, preprocessor)
