...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-transparent flex items-center justify-center py-12 px-4">
      ...
      <svg aria-hidden="true" className="fixed inset-0 pointer-events-none -z-10" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800">
        <defs>
      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-xl p-8 z-10">
