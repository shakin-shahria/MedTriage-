    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <Routes>
          ...
          <Route path="/admin" element={isAuthenticated && role === 'admin' ? <Admin /> : <Navigate to="/login" />} />
          <Route path="/" element={isAuthenticated ? (role === 'admin' ? <Admin /> : <TriageApp />) : <Navigate to="/login" />} />
        </Routes>
      </div>
    </div>
  )
