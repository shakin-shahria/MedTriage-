    ...
    <div>
      <div className="w-full">
        ...
        >
              ...
              MedTriage AI
              <span className="block text-xl md:text-2xl font-normal text-gray-600">Advanced Disease Prediction & Medical Triage</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              AI-powered symptom analysis with evidence-based disease prediction, treatment protocols, and differential diagnosis.
            </p>
        </motion.div>
