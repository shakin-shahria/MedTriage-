            ...
            <div className="bg-white rounded-xl shadow-xl p-6">
              ...
              <div className="mt-6 space-y-3">
                <button
                  ...
                  className="w-full px-4 py-2 bg-gray-500 text-white rounded-lg font-medium hover:bg-gray-600 transition-colors duration-200"
                >
                  Logout
                </button>
                <button
                  onClick={() => navigate('/heart')}
                  className="w-full px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-lg font-medium hover:from-red-600 hover:to-pink-600 transition-all duration-200 shadow-md hover:shadow-lg"
                >
                  ❤️ Heart Triage
                </button>
              </div>
