...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-between py-12 px-0 bg-transparent relative overflow-hidden">
        {/* Left: Demo Image */}
        <div className="flex-1 flex items-center justify-center pr-8">
          <img
            ...
            alt="MedTriage Dashboard Demo"
            className="max-w-lg w-full rounded-2xl shadow-2xl object-cover"
          />
        </div>
