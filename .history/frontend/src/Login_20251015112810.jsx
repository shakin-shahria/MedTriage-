...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="relative z-10 max-w-6xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-3">
        {/* Left: Professional brand panel */}
        <div className="bg-white p-8 flex flex-col items-start justify-center space-y-6 border-r border-gray-100 md:col-span-2">
